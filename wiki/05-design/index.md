...
```mermaid
graph TD
    DES["🎨 Design"] --> UID["User Interaction & Design"]
    DES --> OB["Onboarding Patterns"]
    DES --> GP["Gamification Patterns"]

    UID -->|"Informs first experience"| OB
    ...
    style UID fill:#f9a8d4,stroke:#ec4899,color:#000
    style OB fill:#f9a8d4,stroke:#ec4899,color:#000
    style GP fill:#f9a8d4,stroke:#ec4899,color:#000
    style MET fill:#0891b2,stroke:#0e7490,color:#fff
    style DISC fill:#059669,stroke:#047857,color:#fff
    style RET fill:#0891b2,stroke:#0e7490,color:#fff
```
