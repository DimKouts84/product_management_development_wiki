...
```mermaid
graph TD
    F["🔤 Foundations"] --> BT["Basic Terminology"]
    F --> PDE["Product Document Essentials"]

    BT -->|"Defines terms used in"| PDE
    PDE -->|"References terms from"| BT

    BT -.->|"Feeds into"| REQ["04 · Requirements & User Stories"]
    PDE -.->|"Template for"| DISC["02 · Discovery"]

    style F fill:#7c3aed,stroke:#6d28d9,color:#fff
    style BT fill:#a78bfa,stroke:#7c3aed,color:#fff
    style PDE fill:#a78bfa,stroke:#7c3aed,color:#fff
