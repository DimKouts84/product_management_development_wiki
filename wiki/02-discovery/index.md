...
```mermaid
graph TD
    D["🔍 Discovery"] --> UR["User Research"]
    D --> MA["Market Analysis"]
    D --> RS["Requirements Solicitation"]

    UR -->|"Informs personas for"| MA
    MA -->|"Validates market for"| RS
    RS -->|"Produces backlog for"| DEV["04 · Development"]

    UR -.->|"Feeds into"| DES["05 · Design"]
    MA -.->|"Informs"| STRAT["03 · Strategy"]

    style D fill:#059669,stroke:#047857,color:#fff
    style UR fill:#34d399,stroke:#059669,color:#000
    style MA fill:#34d399,stroke:#059669,color:#000
    style RS fill:#34d399,stroke:#059669,color:#000
