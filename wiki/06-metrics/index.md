...
```mermaid
graph TD
    M["📊 Metrics"] --> SM["Success Metrics"]
    M --> RP["Retention Psychology"]

    SM -->|"Retention metrics explained by"| RP
    RP -->|"Informs design of"| DES["05 · Design"]

    SM -.->|"Validates"| STRAT["03 · Strategy"]
    SM -.->|"Feeds into"| RETRO["08 · Retrospectives"]

    style M fill:#0891b2,stroke:#0e7490,color:#fff
    style SM fill:#67e8f9,stroke:#0891b2,color:#000
    style RP fill:#67e8f9,stroke:#0891b2,color:#000
